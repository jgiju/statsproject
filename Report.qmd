...
```{r}
# insight 3
# Firstly, select three countries on equator(Indonesia, Congo, Kenya), 
#three countries on mid-latitude(Turkey, Argentina, Kazakhstan), 
#and three countries on high-latitude(Norway, Finland, Canada)
countries_equ <- c("Indonesia", "Congo", "Kenya", "Turkey", "Argentina", "Kazakhstan", "Norway", "Finland", "Canada")

# Filter the dataset to include only the specified countries
le_equ <- le %>% filter(Entity %in% countries_equ)
...
#From the result, we can see all factors p-value is less than 0.05, meaning countries is significant for life expectancy. All # three equator countries: Kenya, Congo, and Indonesia showing the large negative relationship with life expectancy. 
# Mid-latitude countries Kazakhstan and Turkey showing a relatively less negative relationship with life expectancy.
# High-latitude countries Norway, Finland, and Canada showing positive relationship with life expectancy.
