...
The model says that for a one unit increase in year, the log odds of surviving to 62 multiplies by 1.075 with a 95% confidence interval of between [1.06, 1.09]. This supports the idea presented in the graphs above: as years progress, the log odds of surviving to 62 increase. 
